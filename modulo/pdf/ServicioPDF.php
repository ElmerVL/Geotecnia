...
class ServicioPDF
{
     ...
     */
    public function __construct(SolicitudDAO $solicitud, EnsayoLaboratorioDAO $ensayoLaboratorio, MuestraDAO $muestra, TrabajoCampoDAO $trabajoCampo)
    {
    ...
    public function crearSolicitud($pdf, $anio)
    {
        ...
        echo "<script language='javascript'>window.open('../prueba.pdf','_self');</script>"; //para ver el archivo pdf creado
        exit;
    }
